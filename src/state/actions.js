...
// export const deleteExample = (id: string, example: Object): Object => ({
//   type: DELETE_EXAMPLE,
//   payload: { id }
// })

export const deleteExample = (id: string, example: Object): Function =>  async (
  dispatch: Function
): Promise<void> => {


  const response = await fetch(`${ROOT_PATH}delete`, {
    method: 'POST',
    headers: {
