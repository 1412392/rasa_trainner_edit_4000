...
function createExample({key='', text='', intent='', entities=[]}) {
  return {
    text,
    key,
    intent,
...
export default function reducer (
  ...
  switch (type) {
    ...
    case DELETE_EXAMPLE: {
      ...
      //console.log(state.originalSource.rasa_nlu_data.common_examples[id-1]);
      var key=state.originalSource.rasa_nlu_data.common_examples[id-1].key;
      console.log(key);
